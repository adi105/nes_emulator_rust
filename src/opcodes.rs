...
lazy_static! {
    pub static ref CPU_OP_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x65, "ADC", 2, 3, AddressingMode::ZP0),
        OpCode::new(0x75, "ADC", 2, 4, AddressingMode::ZPX),
        OpCode::new(0x6d, "ADC", 3, 4, AddressingMode::ABS),
        OpCode::new(0x7d, "ADC", 3, 4/*+1 if page crossed*/, AddressingMode::ABX),
        OpCode::new(0x79, "ADC", 3, 4/*+1 if page crossed*/, AddressingMode::ABY),
        OpCode::new(0x61, "ADC", 2, 6, AddressingMode::IZX),
        OpCode::new(0x71, "ADC", 2, 5/*+1 if page crossed*/, AddressingMode::IZY),

        OpCode::new(0xe9, "SBC", 2, 2, AddressingMode::IMM),
        OpCode::new(0xe5, "SBC", 2, 3, AddressingMode::ZP0),
        OpCode::new(0xf5, "SBC", 2, 4, AddressingMode::ZPX),
        OpCode::new(0xed, "SBC", 3, 4, AddressingMode::ABS),
        OpCode::new(0xfd, "SBC", 3, 4/*+1 if page crossed*/, AddressingMode::ABX),
        OpCode::new(0xf9, "SBC", 3, 4/*+1 if page crossed*/, AddressingMode::ABY),
        OpCode::new(0xe1, "SBC", 2, 6, AddressingMode::IZX),
        OpCode::new(0xf1, "SBC", 2, 5/*+1 if page crossed*/, AddressingMode::IZY),

        OpCode::new(0x29, "AND", 2, 2, AddressingMode::IMM),
        OpCode::new(0x25, "AND", 2, 3, AddressingMode::ZP0),
        OpCode::new(0x35, "AND", 2, 4, AddressingMode::ZPX),
        OpCode::new(0x2d, "AND", 3, 4, AddressingMode::ABS),
        OpCode::new(0x3d, "AND", 3, 4/*+1 if page crossed*/, AddressingMode::ABX),
        OpCode::new(0x39, "AND", 3, 4/*+1 if page crossed*/, AddressingMode::ABY),
        OpCode::new(0x21, "AND", 2, 6, AddressingMode::IZX),
        OpCode::new(0x31, "AND", 2, 5/*+1 if page crossed*/, AddressingMode::IZY),

        OpCode::new(0x49, "EOR", 2, 2, AddressingMode::IMM),
        OpCode::new(0x45, "EOR", 2, 3, AddressingMode::ZP0),
        OpCode::new(0x55, "EOR", 2, 4, AddressingMode::ZPX),
        OpCode::new(0x4d, "EOR", 3, 4, AddressingMode::ABS),
        OpCode::new(0x5d, "EOR", 3, 4/*+1 if page crossed*/, AddressingMode::ABX),
        OpCode::new(0x59, "EOR", 3, 4/*+1 if page crossed*/, AddressingMode::ABY),
        OpCode::new(0x41, "EOR", 2, 6, AddressingMode::IZX),
        OpCode::new(0x51, "EOR", 2, 5/*+1 if page crossed*/, AddressingMode::IZY),

        OpCode::new(0x09, "ORA", 2, 2, AddressingMode::IMM),
        OpCode::new(0x05, "ORA", 2, 3, AddressingMode::ZP0),
        OpCode::new(0x15, "ORA", 2, 4, AddressingMode::ZPX),
        OpCode::new(0x0d, "ORA", 3, 4, AddressingMode::ABS),
        OpCode::new(0x1d, "ORA", 3, 4/*+1 if page crossed*/, AddressingMode::ABX),
        OpCode::new(0x19, "ORA", 3, 4/*+1 if page crossed*/, AddressingMode::ABY),
        OpCode::new(0x01, "ORA", 2, 6, AddressingMode::IZX),
        OpCode::new(0x11, "ORA", 2, 5/*+1 if page crossed*/, AddressingMode::IZY),
        ...
        OpCode::new(0xa5, "LDA", 2, 3, AddressingMode::ZP0),
        OpCode::new(0xb5, "LDA", 2, 4, AddressingMode::ZPX),
        OpCode::new(0xad, "LDA", 3, 4, AddressingMode::ABS),
        OpCode::new(0xbd, "LDA", 3, 4/*+1 if page crossed*/, AddressingMode::ABX),
        OpCode::new(0xb9, "LDA", 3, 4/*+1 if page crossed*/, AddressingMode::ABY),
        OpCode::new(0xa1, "LDA", 2, 6, AddressingMode::IZX),
        OpCode::new(0xb1, "LDA", 2, 5/*+1 if page crossed*/, AddressingMode::IZY),

        OpCode::new(0xa2, "LDX", 2, 2, AddressingMode::IMM),
        OpCode::new(0xa6, "LDX", 2, 3, AddressingMode::ZP0),
        OpCode::new(0xb6, "LDX", 2, 4, AddressingMode::ZPY),
        OpCode::new(0xae, "LDX", 3, 4, AddressingMode::ABS),
        OpCode::new(0xbe, "LDX", 3, 4/*+1 if page crossed*/, AddressingMode::ABY),

        OpCode::new(0xa0, "LDY", 2, 2, AddressingMode::IMM),
        OpCode::new(0xa4, "LDY", 2, 3, AddressingMode::ZP0),
        OpCode::new(0xb4, "LDY", 2, 4, AddressingMode::ZPX),
        OpCode::new(0xac, "LDY", 3, 4, AddressingMode::ABS),
        OpCode::new(0xbc, "LDY", 3, 4/*+1 if page crossed*/, AddressingMode::ABX),


        OpCode::new(0x85, "STA", 2, 3, AddressingMode::ZP0),
        OpCode::new(0x95, "STA", 2, 4, AddressingMode::ZPX),
        OpCode::new(0x8d, "STA", 3, 4, AddressingMode::ABS),
        OpCode::new(0x9d, "STA", 3, 5, AddressingMode::ABX),
        OpCode::new(0x99, "STA", 3, 5, AddressingMode::ABY),
        OpCode::new(0x81, "STA", 2, 6, AddressingMode::IZX),
        OpCode::new(0x91, "STA", 2, 6, AddressingMode::IZY),

        OpCode::new(0x86, "STX", 2, 3, AddressingMode::ZP0),
        OpCode::new(0x96, "STX", 2, 4, AddressingMode::ZPY),
        OpCode::new(0x8e, "STX", 3, 4, AddressingMode::ABS),

        OpCode::new(0x84, "STY", 2, 3, AddressingMode::ZP0),
        OpCode::new(0x94, "STY", 2, 4, AddressingMode::ZPX),
    ...
    pub static ref OPCODES_MAP: HashMap<u8, &'static OpCode> = {
        ...
        for opp in &*CPU_OP_CODES {
            map.insert(opp.code, opp);
        }
        map
    };
}