...
// next direction is stored in memory location 0xff
...
// scan if screen changes using a buffer, 
// only call update functions in case of screen change, rather than every callback
